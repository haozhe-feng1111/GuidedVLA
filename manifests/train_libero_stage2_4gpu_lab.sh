...
# Run from the GuidedVLA repository root after Stage 1 step 30000 exists:
#   bash manifests/train_libero_stage2_4gpu_lab.sh
...
RUN_ID="guidedvla_libero_stage2_object_depth_skill_4gpu_30k"
