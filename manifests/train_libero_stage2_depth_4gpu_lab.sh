...
# Depth-only Stage 2 on 4 GPUs. Derived from
# manifests/train_libero_stage2_4gpu_lab.sh at GuidedVLA commit 5fa77b8.
# Usage:
#   bash manifests/train_libero_stage2_depth_4gpu_lab.sh
...
DEPTH_MODEL="${BASE}/models/da3-small-e08cab65"
