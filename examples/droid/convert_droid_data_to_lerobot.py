...
If you want to push your dataset to the Hugging Face Hub as a private dataset, use:
...
def main(data_dir: str, *, push_to_hub: bool = False, private: bool = True):
    ...
    # Optionally push to the Hugging Face Hub. Keep private by default so users
    # do not accidentally publish datasets while testing the converter.
    if push_to_hub:
        dataset.push_to_hub(
...
##########################################################################################################
################ Helper functions for parsing raw DROID data                     #########################
################ These utilities are adapted from the public R2D2 converter.     #########################
